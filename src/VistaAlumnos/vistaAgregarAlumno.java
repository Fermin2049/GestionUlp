...
public class vistaAgregarAlumno extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTextDni.setToolTipText("Ingresar Numero de Legajo.");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextDni, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonGuardarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarAlumnoActionPerformed
        ...
        Date fechNac = (Date) jDateFechaNac.getDate();
        int dni = Integer.parseInt(jTextDni.getText());
        
        LocalDate localdate = fechNac.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();// ulise esta forma me parece menos compleja
        
        Alumno a = new Alumno(nombre, apellido, dni, localdate, true);
    ...
    private void jTextDniFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextDniFocusLost
       try{
        int legajo=Integer.parseInt(jTextDni.getText());
